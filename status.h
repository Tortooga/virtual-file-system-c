...
typedef enum
{
    ...
    INVALID_CHARECTER_IN_IDENTIFIER = -53,
    ...
    CMD_UNKNOWN_OPT = -435,
    CMD_UNKNOWN_ARG = -436,
    CMD_EXPECTED_INT = -437,
    CMD_EXPECTED_POSATIVE_NUMBER = -438,
    CMD_INPUT_OUT_OF_RANGE = -439,
    
    REQUESTED_TOO_MANY_BYTES = -441,
} StatusCode;
